...
This repository is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/relibc.git`](https://gitlab.redox-os.org/redox-os/relibc.git) carrying E-OS changes. The full
