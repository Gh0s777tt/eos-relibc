...
This is a **type-C fork** of [`https://gitlab.redox-os.org/redox-os/relibc.git`](https://gitlab.redox-os.org/redox-os/relibc.git). Read [`CLAUDE.md`](CLAUDE.md) first — the
