...
Fork [`https://gitlab.redox-os.org/redox-os/relibc.git`](https://gitlab.redox-os.org/redox-os/relibc.git) niosący zmiany E-OS. Gałąź, którą buduje E-OS, to **`eos-july`**,
